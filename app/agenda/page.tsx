...
export default function AgendaPage() {
  ...
  <div className="max-w-6xl mx-auto p-2 space-y-2">
      <Card>
        ...
        <CardContent>
          <div className="rounded-lg shadow-lg border bg-background" style={{ width: '100%', height: '70vh', minHeight: 400, maxHeight: '80vh', display: 'flex', flexDirection: 'column', borderColor: 'hsl(var(--border))' }}>
            <Calendar
              localizer={localizer}
              events={events}
              startAccessor="start"
              ...
              culture="pt-BR"
              style={{ flex: 1, width: '100%', height: '100%', background: 'hsl(var(--background))', color: 'hsl(var(--foreground))', borderRadius: 12, boxShadow: '0 2px 16px #0001', border: '1px solid hsl(var(--border))' }}
              ...
              components={{
                event: ({ event }: { event: any }) => (
                  <div className="p-2 hover:bg-accent rounded-lg transition-all">
